...
/***/ function(module, exports, __webpack_require__) {
	...
	var ORIGIN = 'https://letyshops.zendesk.com/api/v2/'; // import '../sass/app.scss'
	
	var SUFFIX = 'help_center/ru/';
	var SECTIONS = '' + ORIGIN + SUFFIX + 'sections';
	
	var sectionsListTemplate = __webpack_require__(2);
	var articlesListTemplate = __webpack_require__(22);
	var preloader = __webpack_require__(23);
	
	var getSections = function getSections(cb) {
	
	  (0, _jquery2.default)('#sections').html(preloader());
	  ...
	  _jquery2.default.ajax({
	    ...
	    (0, _jquery2.default)('#sections').html(sectionsListTemplate(response));
	
	    var initialSection = response.sections[0];
	
	    if (typeof cb == 'function') cb(initialSection);
	  });
	};
	
	var getArticles = function getArticles(data, cb) {
	
	  (0, _jquery2.default)('#articles').html(preloader());
	
	  _jquery2.default.get('' + ORIGIN + SUFFIX + 'sections/' + data.id + '/articles', function (response) {
	    ...
	    (0, _jquery2.default)('#articles').html(articlesListTemplate(articlesList));
	...
	(0, _jquery2.default)(document).on('click', '[data-section]', function (e) {
	
	  e.preventDefault();
	
	  var id = (0, _jquery2.default)(this).data('section'),
	      name = (0, _jquery2.default)(this).data('name');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>"
	    + container.escapeExpression(((helper = (helper = helpers.sectionTitle || (depth0 != null ? depth0.sectionTitle : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(alias1,{"name":"sectionTitle","hash":{},"data":data}) : helper)))
	    + "</h3>\n<hr>\n<ul class=\"list-group\">\n"
	    + ((stack1 = helpers.each.call(alias1,((stack1 = (depth0 != null ? depth0.data : depth0)) != null ? stack1.articles : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "</ul>\n";
	},"useData":true});
